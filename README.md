...
Please check our [code](https://github.com/CINAPSLab/MATT-Diff.git) in Existential Robotics Laboratory (ERL) GitHub Organization.
This repository is a PyTorch implementation for paper ***[MATT--Diff: Multimodal Active Target Tracking by Diffusion Policy](https://arxiv.org/pdf/)***
